...
import { AppsV1Api, CoreV1Api, type KubeConfig, type V1Deployment, type V1Pod, type V1Service } from '@kubernetes/client-node';
...
class TestablePortForwardConnectionService extends PortForwardConnectionService {
  ...
  public override isPodResource(resource: PortForwardableResource): boolean {
    return super.isPodResource(resource);
  }

  public override isDeploymentResource(resource: PortForwardableResource): boolean {
    return super.isDeploymentResource(resource);
  }

  public override isServiceResource(resource: PortForwardableResource): boolean {
...
describe('PortForwardConnectionService', () => {
  ...
  beforeEach(() => {
    service = new TestablePortForwardConnectionService(mockKubeConfig);
    global.fetch = vi.fn();
